// Auto-generated MTEF character tables (ported from zhexiao/mtef-go).
// Maps MathType MTCode values to LaTeX fragments.

export const SPECIAL_CHAR: Record<string, string> = {
  "!": "\\!",
  "#": "\\#",
  "$": "\\$",
  "%": "\\%",
...
export const MTEF_CHARS: Record<string, string> = {
  "char/0x0020": " ",
  "char/0x0021": "!",
  "char/0x0022": "''",
